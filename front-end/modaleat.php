  ...
  <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header bg-success text-white">
        <h5 class="modal-title" id="exampleModalCenterTitle">Eating information</h5>
					...
					<div class="col-5">
        	        	<div class="card-block">
        	   	        	<div class="card-header bg-dark text-white">
      							<h3 class="card-title">Eating type</h3>
							</div>
                    		<p class="card-text ml-1">info skal her fx. til restaurant eller café</p>
 					...
 					<div class="col-7">
                		<img class="img-fluid rounded-0" id="sights" src="img/eat.PNG" alt="Card image cap">
            		</div>
				</div>
  			</div>
		</div>
