				...
				<div class="col-5">
                	<div class="card-block">
           	        	<div class="card-header bg-dark text-white rounded-0">
      						<h3 class="card-title">Excursion type</h3>
						</div>
                    	<p class="card-text ml-1">info skal her fx. tur til vandfald</p>
						<p class="card-text ml-1">Pris inkl.: blabla</p>
						<a href="#"><p class="card-text ml-1">Læs mere om turen her LINK</p></a>
 				...
 				<div class="col-7">
                	<img class="img-fluid rounded-0" id="sights" src="img/sights.PNG" alt="Card image cap">
            	</div>
			</div>
  		</div>
		</div>
